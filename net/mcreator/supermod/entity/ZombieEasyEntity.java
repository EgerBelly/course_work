...
/*     */ 
/*     */ public class ZombieEasyEntity extends Monster {
/*     */   public ZombieEasyEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  36 */     this((EntityType<ZombieEasyEntity>)SupermodModEntities.ZOMBIE_EASY.get(), world);
/*     */   }
/*     */   
/*     */   public ZombieEasyEntity(EntityType<ZombieEasyEntity> type, Level world) {
/*  40 */     super(type, world);
/*  41 */     this.f_21364_ = 4;
/*  42 */     m_21557_(false);
/*  43 */     m_21530_();
...
/* 110 */     builder = builder.m_22268_(Attributes.f_22276_, 20.0D);
/* 111 */     builder = builder.m_22268_(Attributes.f_22284_, 0.0D);
/* 112 */     builder = builder.m_22268_(Attributes.f_22281_, 6.0D);
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\entity\ZombieEasyEntity.class
