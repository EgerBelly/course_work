...
/*    */ import net.mcreator.supermod.procedures.Proc6Procedure;
...
/* 49 */     if (Proc6Procedure.execute((Entity)localPlayer)) {
/* 50 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scull.png"));
/* 51 */       Gui.m_93133_(event.getPoseStack(), posX + -18, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
...
/* 57 */       Gui.m_93133_(event.getPoseStack(), posX + 0, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 59 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 60 */       Gui.m_93133_(event.getPoseStack(), posX + 9, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
...
/* 66 */       Gui.m_93133_(event.getPoseStack(), posX + 27, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 68 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 69 */       Gui.m_93133_(event.getPoseStack(), posX + 36, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
...
/* 84 */       Gui.m_93133_(event.getPoseStack(), posX + -27, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 86 */       (Minecraft.m_91087_()).f_91062_.m_92889_(event.getPoseStack(), (Component)Component.m_237115_("gui.supermod.qwer_5.label_empty"), (posX + -63), (posY + -121), -1);
/*    */     } 
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\client\screens\Qwer5Overlay.class
