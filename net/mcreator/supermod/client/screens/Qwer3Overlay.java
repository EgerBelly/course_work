...
/*    */ import net.mcreator.supermod.procedures.Proc4Procedure;
...
/* 49 */     if (Proc4Procedure.execute((Entity)localPlayer)) {
...
/* 63 */       Gui.m_93133_(event.getPoseStack(), posX + 0, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
...
/* 72 */       Gui.m_93133_(event.getPoseStack(), posX + 27, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 74 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 75 */       Gui.m_93133_(event.getPoseStack(), posX + 36, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 77 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 78 */       Gui.m_93133_(event.getPoseStack(), posX + 45, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
...
/*    */       
/* 86 */       (Minecraft.m_91087_()).f_91062_.m_92889_(event.getPoseStack(), (Component)Component.m_237115_("gui.supermod.qwer_3.label_empty"), (posX + -63), (posY + -121), -1);
/*    */     } 
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\client\screens\Qwer3Overlay.class
