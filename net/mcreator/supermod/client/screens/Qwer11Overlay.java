...
/*    */ import net.mcreator.supermod.procedures.Proc12Procedure;
...
/* 49 */     if (Proc12Procedure.execute((Entity)localPlayer)) {
/* 50 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scull.png"));
/* 51 */       Gui.m_93133_(event.getPoseStack(), posX + 36, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
...
/*    */       
/* 56 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scull.png"));
/* 57 */       Gui.m_93133_(event.getPoseStack(), posX + 27, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 59 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scull.png"));
/* 60 */       Gui.m_93133_(event.getPoseStack(), posX + 18, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 62 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scull.png"));
/* 63 */       Gui.m_93133_(event.getPoseStack(), posX + 9, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 65 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scull.png"));
...
/*    */       
/* 86 */       (Minecraft.m_91087_()).f_91062_.m_92889_(event.getPoseStack(), (Component)Component.m_237115_("gui.supermod.qwer_11.label_empty"), (posX + -63), (posY + -121), -1);
/*    */     } 
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\client\screens\Qwer11Overlay.class
