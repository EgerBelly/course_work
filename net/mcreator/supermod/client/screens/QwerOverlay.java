...
/*    */ import net.mcreator.supermod.procedures.Proc1Procedure;
...
/* 49 */     if (Proc1Procedure.execute((Entity)localPlayer)) {
/* 50 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 51 */       Gui.m_93133_(event.getPoseStack(), posX + -54, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 53 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 54 */       Gui.m_93133_(event.getPoseStack(), posX + -45, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 56 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 57 */       Gui.m_93133_(event.getPoseStack(), posX + -36, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 59 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 60 */       Gui.m_93133_(event.getPoseStack(), posX + -27, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 62 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 63 */       Gui.m_93133_(event.getPoseStack(), posX + -18, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 65 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 66 */       Gui.m_93133_(event.getPoseStack(), posX + -9, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 68 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 69 */       Gui.m_93133_(event.getPoseStack(), posX + 0, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 71 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 72 */       Gui.m_93133_(event.getPoseStack(), posX + 9, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 74 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 75 */       Gui.m_93133_(event.getPoseStack(), posX + 18, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 77 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 78 */       Gui.m_93133_(event.getPoseStack(), posX + 27, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 80 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 81 */       Gui.m_93133_(event.getPoseStack(), posX + 36, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 83 */       RenderSystem.m_157456_(0, new ResourceLocation("supermod:textures/screens/scullblac.png"));
/* 84 */       Gui.m_93133_(event.getPoseStack(), posX + 45, posY + -112, 0.0F, 0.0F, 8, 8, 8, 8);
/*    */       
/* 86 */       (Minecraft.m_91087_()).f_91062_.m_92889_(event.getPoseStack(), (Component)Component.m_237115_("gui.supermod.qwer.label_empty"), (posX + -63), (posY + -121), -1);
/*    */     } 
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\client\screens\QwerOverlay.class
