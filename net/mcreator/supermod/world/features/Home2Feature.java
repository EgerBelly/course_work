...
/*    */ 
/*    */ public class Home2Feature extends Feature<NoneFeatureConfiguration> {
/* 28 */   public static Home2Feature FEATURE = null;
...
/* 33 */     FEATURE = new Home2Feature();
/* 34 */     CONFIGURED_FEATURE = FeatureUtils.m_206488_("supermod:home_2", FEATURE, (FeatureConfiguration)FeatureConfiguration.f_67737_);
/* 35 */     PLACED_FEATURE = PlacementUtils.m_206509_("supermod:home_2", CONFIGURED_FEATURE, List.of());
/* 36 */     return FEATURE;
/*    */   }
/*    */   
...
/* 51 */       this.template = context.m_159774_().m_6018_().m_215082_().m_230359_(new ResourceLocation("supermod", "loot2")); 
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\world\features\Home2Feature.class
