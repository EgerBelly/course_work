...
/*    */ 
/*    */ public class Home1Feature extends Feature<NoneFeatureConfiguration> {
/* 28 */   public static Home1Feature FEATURE = null;
...
/* 33 */     FEATURE = new Home1Feature();
/* 34 */     CONFIGURED_FEATURE = FeatureUtils.m_206488_("supermod:home_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.f_67737_);
/* 35 */     PLACED_FEATURE = PlacementUtils.m_206509_("supermod:home_1", CONFIGURED_FEATURE, List.of());
/* 36 */     return FEATURE;
/*    */   }
/*    */   
...
/* 51 */       this.template = context.m_159774_().m_6018_().m_215082_().m_230359_(new ResourceLocation("supermod", "loot1")); 
...
/* Location:              D:\MODdelatbydy\superMod.jar!\net\mcreator\supermod\world\features\Home1Feature.class
